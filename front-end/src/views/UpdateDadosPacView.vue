...
export default {
    ...
    methods: {
        ...
        async getDados() {
            ...
            Axios.get(`https://clinica-maria-luiza-bjdd.onrender.com/paciente/dados/${this.id}`, {
                headers: {
        ...
        async editarDadosPaciente() {
            ...
            try {
                ...
                await Axios.post(`https://clinica-maria-luiza-bjdd.onrender.com/editar/dados/paciente`, {
                    dados: {
